...
const Register = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const { _id, name: userName, email: userEmail, token, refreshToken } = response.data;

            setAuth({ _id, name: userName, email: userEmail }, token, refreshToken);
        ...
        <div className="flex items-center justify-center min-h-[80vh]">
            <Card className="w-full max-w-md">
                <CardHeader className="space-y-1">
                    ...
                    <CardDescription>
                        Enter your details to create your HireForge account
                    </CardDescription>
                </CardHeader>
                <CardContent>
