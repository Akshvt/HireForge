    ...
    },
    {
      ...
      content: (
        <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
          ...
          <p><strong className="text-foreground">Response time:</strong> Within 48 hours for general questions; within 30 days for formal data access/deletion requests as required by law.</p>
          <p>HireForge is part of the CodeSage ecosystem. The data controller responsible for your information is CodeSage Technologies.</p>
        </div>
      ),
    },
  ];
