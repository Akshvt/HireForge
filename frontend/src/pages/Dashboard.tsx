...
function StatCardContent({
  ...
  return (
    <div className="p-5 flex flex-col gap-3 group">
      ...
      <div>
        <p className="text-3xl font-bold font-jakarta text-starlight group-hover:text-nebula transition-all duration-300">{animatedValue}</p>
  ...
  return (
    <main className="min-h-screen pb-20 overflow-x-hidden">
      ...
      <section className="relative pt-12 pb-16 px-6">
        <div className="absolute top-0 right-0 w-[500px] h-[400px] bg-[radial-gradient(circle_at_top_right,rgba(99,102,241,0.08)_0,transparent_60%)] -z-10 pointer-events-none" />
        <div className="container max-w-6xl mx-auto">
          ...
          >
            <div className="space-y-2">
              <h1 className="text-4xl md:text-5xl font-black text-starlight font-jakarta tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-10 order-2 lg:order-1">
            ...
            {isResumeUploaded ? (
              ...
              >
                <div className="mb-6">
                   <h2 className="text-2xl font-black text-starlight font-jakarta tracking-tight">Upload Resume</h2>
          ...
          <div className="lg:col-span-4 space-y-8 order-1 lg:order-2">
               ...
               >
                  <GlassCard index={0} glowColor="aurora">
                     <div className="p-6 space-y-6">
                        <div className="flex items-center justify-between">
                           <h3 className="font-bold text-starlight">Active Profile</h3>
            ...
            <GlassCard index={1} glowColor="cyan">
               <div className="p-6 space-y-4">
                  ...
                  <h4 className="font-bold text-starlight">Pro Tip</h4>
