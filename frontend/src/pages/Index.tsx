    ...
    <div className="flex flex-col gap-0 pb-0 overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative px-4 pt-32 pb-40 text-center md:pt-44 md:pb-60">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-nebula/10 blur-[120px] rounded-full opacity-50" />
          <div className="absolute top-[20%] left-[10%] w-[500px] h-[400px] bg-cyan/5 blur-[100px] rounded-full" />
          <div className="absolute top-[10%] right-[5%] w-[600px] h-[500px] bg-aurora/5 blur-[120px] rounded-full" />
        </div>
        ...
        >
          ...
          {/* Headline */}
          <motion.h1
            className="text-6xl md:text-8xl font-black tracking-tight text-white leading-[0.95] md:leading-[1.1] font-jakarta"
          ...
          >
            ...
            <MagneticButton
              ...
              className="h-14 px-8 text-base font-medium border-white/10 hover:bg-white/5"
            >
              See the Engine
            </MagneticButton>
          </motion.div>
          ...
          {/* Ecosystem Info */}
          <motion.div
            className="flex items-center justify-center gap-6 pt-6 opacity-60 grayscale hover:grayscale-0 transition-all duration-500"
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.6 }}
          ...
          {features.map((f, i) => (
            ...
            >
              <div className="p-10 space-y-6 relative overflow-hidden group">
                <div className={`absolute top-0 right-0 w-32 h-32 bg-${f.glowColor}/10 blur-[50px] rounded-full -translate-y-1/2 translate-x-1/2 transition-all group-hover:blur-[70px]`} />
                ...
                <div className="space-y-3">
                  <h3 className="text-2xl font-bold text-white font-jakarta">{f.title}</h3>
      ...
      <section className="py-20 border-y border-white/5 bg-white/[0.01]">
        <div className="container mx-auto px-6">
          <p className="text-center text-[10px] font-black uppercase tracking-[0.4em] text-dust/40 mb-12">Trusted by engineers at world-class companies</p>
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-30 grayscale hover:grayscale-0 transition-all duration-700">
            {["Google", "Meta", "Stripe", "Netflix", "Amazon", "Linear"].map(company => (
              <div key={company} className="text-2xl font-black text-starlight select-none font-space tracking-tighter">
                {company}
              </div>
            ))}
          </div>
      ...
      <RevealSection className="py-32 bg-surface-deep/50 border-y border-white/5 relative">
        <div className="container max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="grid grid-cols-2 gap-8 pt-4">
              {[
                ...
                <div key={stat.label} className="space-y-1">
                  <p className="text-3xl font-black text-white font-space">{stat.val}</p>
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-nebula/20 blur-[100px] rounded-full opacity-50 group-hover:opacity-80 transition-opacity" />
            <ATSScoreDemo />
          </div>
        </div>
      </RevealSection>
      ...
      <RevealSection className="py-40 px-6">
        <div className="container max-w-6xl mx-auto space-y-16">
          <div className="text-center space-y-4">
            <h2 className="text-4xl md:text-6xl font-black text-white font-jakarta tracking-tight">The developer standard.</h2>
      ...
      <RevealSection className="py-40 relative">
        ...
        <div className="container max-w-4xl mx-auto px-6 text-center space-y-10 relative">
          ...
          <h2 className="text-5xl md:text-7xl font-black text-white font-jakarta tracking-tight">Your next chapter <br /><span className="text-gradient">starts here.</span></h2>
