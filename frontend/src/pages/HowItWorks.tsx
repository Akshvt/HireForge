...
const steps = [
  ...
  },
  {
    ...
    description: "HireForge doesn't just tell you what's wrong — it shows you exactly how to fix it. Powered by the same CodeSage AI that reviews millions of lines of code, our suggestions are precise and contextual.",
    details: [
    ...
    tip: "💡 Powered by CodeSage AI — the same engine used by 100,000+ developers.",
    codesage: true,
  },
  {
    number: "04",
  ...
  return (
    <div className="flex flex-col min-h-screen bg-void">
      ...
      <section className="relative px-6 pt-32 pb-20 text-center overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-5xl h-[500px] bg-nebula/5 blur-[120px] rounded-full -z-10" />
      ...
      <section className="py-32 px-6 border-t border-white/5 relative overflow-hidden">
        ...
        <div className="container max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <MagneticButton onClick={() => window.open("https://codesage.dev", "_blank")} variant="glass" size="lg" className="h-14 px-8 font-bold border-white/10">
              Visit CodeSage
            </MagneticButton>
