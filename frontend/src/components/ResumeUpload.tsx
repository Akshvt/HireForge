      ...
      <div className="p-6">
        ...
        <div
          ...
          className={cn(
            ...
            isDragging
              ? "border-nebula bg-nebula/5 scale-[1.03] shadow-[0_0_40px_rgba(99,102,241,0.2)]"
              : "border-white/10 hover:border-nebula/30",
                  ...
                  <div className="relative">
                    ...
                    <div
                      className={cn(
                        ...
                        isDragging
                          ? "bg-gradient-to-br from-nebula to-cyan shadow-[0_0_50px_rgba(99,102,241,0.4)]"
                          : "bg-white/5"
                      )}
                    >
                      <Upload
