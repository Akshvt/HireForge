...
import { Briefcase, User, LogOut, LayoutDashboard, Info, BookOpen, Code2, HelpCircle, Zap, Sun, Moon } from "lucide-react";
        ...
        <div className="flex h-16 items-center justify-between px-6">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Button
              ...
              className="rounded-full text-dust hover:text-starlight hover:bg-white/5 dark:hover:bg-white/10 transition-colors"
            >
